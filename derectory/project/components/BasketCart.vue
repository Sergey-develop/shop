<template>
  <div class="basket-cart">
    ...
    <div class="basket-cart-info">
      ...
      <div class="basket-cart-rate">
        <div class="basket-cart-rate-icon">
        ...
        <div class="basket-cart-rate-count">
          {{ this.$props.item.rating }}
        </div>
      </div>
    </div>

    <div class="basket-cart-delete" :data-id="item.id" @click="delItem">
...
export default {
  ...
  methods: {
    ...
    let itemId = +e.target.getAttribute('data-id')
      this.$store.commit('bDell', itemId);
    }
  }
}
...
.basket-cart-delete svg {
  pointer-events: none;
}

.basket-cart-delete svg path {
  fill: #959DAD;
}

.basket-cart-delete svg:hover path {
  fill: #1F1F1F;
}
